...
void Server::sendOrSchedule(cMessage *msg, simtime_t delay)
{
    if (delay == 0)
        sendBack(msg);
    else
...
void Server::sendBack(cMessage *msg)
{
...
//    while (size_t(queue.length) > 0) {
//        auto c = queue.pop();
//        cMessage* msg = check_and_cast<cMessage *>(c);
//        handleMessage(msg);
//    }
//}
