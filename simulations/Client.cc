...
void Client::handleStartOperation(LifecycleOperation *operation)
{
...
void Client::handleStopOperation(LifecycleOperation *operation)
{
...
void Client::handleCrashOperation(LifecycleOperation *operation)
{
    cancelEvent(timeoutMsg);
...
void Client::socketEstablished(TcpSocket *socket)
{
...
void Client::rescheduleOrDeleteTimer(simtime_t d, short int msgKind)
{
    cancelEvent(timeoutMsg);
...
void Client::socketClosed(TcpSocket *socket)
{
...
void Client::socketFailure(TcpSocket *socket, int code)
{
